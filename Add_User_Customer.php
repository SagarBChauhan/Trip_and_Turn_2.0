                        ...
                        <li class="nav-item active">              
                            <a class="nav-link" data-toggle="collapse" href="#collapseUser1" aria-expanded="false" aria-controls="collapseUser1">
                              ...
                              <div class="collapse" id="collapseUser1">
                                    <ul class="nav">
                                        <li class="nav-item active"><a class="nav-link" href="Add_User_Customer.php"><i class="fas fa-plus"></i> Add Customer</a></li>
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray" href="User_Manager.php">User Management: Customer <i class="fas fa-filter"></i> Add</a>/
                  <a class="navbar-brand text-gray-dark" href="Add_User_Customer.php">Add Customer</a>
              </span>
          </div>
                ...
                <div class="card-body">  
                    ...
                    <form id="myForm"  method="POST">
                      ...
                      <div class="row">   
                        ...
                        <div class="col-md-4">                        
                          <div class="form-group">                          
                              <label for="email" class="bmd-label-floating" ><i class="fas fa-envelope"></i> Email <span id="txtHint1"></span></label>
                                <input type="email" name="email" class="form-control" onchange="checkEmail(this.value)" id="email" required>
                          </div>
                        </div>
                      </div>
                      <div class="form-row">
                      ...
                      <div class="row">
                        ...
                        <button type='submit' name="btn_Add_Customer" id="btn_Add_Customer" class="btn btn-primary  pull-right" disabled="">Add  <i class="fas fa-plus"></i></button>
        ...
        <script>
            function checkUsername(str) {
              ...
              if (str == "") {
                ...
                $("#feedback").remove();
                $("#uname").parent().addClass("has-danger");
                $("#uname").parent().append('<span id="feedback" class="material-icons form-control-feedback">clear</span>');
                return;
              }
              ...
              xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                  if(this.responseText=='ok')
                  {
                    ...
                    $("#btn_Add_Customer").attr('disabled',false);
                    $("#uname").parent().removeClass("has-danger");
                    $("#feedback").remove();
                    $("#uname").parent().addClass("has-success");
                    $("#uname").parent().append('<span id="feedback" class="form-control-feedback"><i class="material-icons">done</i></span>');
                  }
            ...
            function checkEmail(str) {
              ...
              xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                  if(this.responseText=='ok')
                  {
                    document.getElementById("txtHint1").innerHTML = "<span class='badge badge-pill badge-success'>available <i class='fas fa-check'></i></span>";
                    $("#btn_Add_Customer").attr('disabled',false);
                  ...
                  {
                    document.getElementById("txtHint1").innerHTML = "<span  class='badge badge-pill badge-danger'>unavailable <i class='fas fa-close'></i></span>";
                    $("#btn_Add_Customer").attr('disabled',true);
              ...
              xhttp.open("GET", "operations/checkEmail.php?email="+str, true);
              xhttp.send();
            }
        </script>
        <!--check email ends-->
            ...
            $(document).ready(function (){
                ...
                function subform(){
                    ...
                    $.ajax({
                        ...
                        beforeSend: function () {
                            $("#info").fadeOut();
                            $("#btn_Add_Customer").html("Please Wait <i class='fas fa-spinner fa-spin'></i>");
                        },
                        success: function (resp) {
                            if(resp=='Added'){
                                $("#btn_Add_Customer").html("Added");
                                notify('Customer Added <i class="fas fa-check faa-burst animated faa-fast></i>','success','top','center');
                            }
                            else
                            {
                                $("#info").fadeIn(1000,function (){
//                                    $("#info").html("<div class='alert alert-danger'>"+resp+"</div>");
                                    $("#btn_Add_Customer").html('Add');
                                }) 
