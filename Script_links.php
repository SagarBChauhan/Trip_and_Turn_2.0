...
//            notify('Message <i class="fas fa-check faa-burst animated faa-fast></i>','warning','top','center')
</script>

<!--code for sidebar toogle-->
<script>
    $(document).ready(function() {
        $(".view-change").on('click', function() {
//            $(".sidebar").fadeToggle(200);
//            $(".sidebar").css({"width": "76px", "overflow-x": "hidden","margin-left": "-10px",});
            $(".sidebar").toggleClass('w-5');
            $(".sidebar").children().children().children().children().children().next().toggleClass('tp');
//            $(".main-panel").toggleClass('w-100');
//            $(".main-panel").css({"width":"96%"});
            $(".main-panel").toggleClass('w-95');
        });
