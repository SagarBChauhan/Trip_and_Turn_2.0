...
<head>
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css" integrity="sha384-UHRtZLI+pbxtHCWp1t77Bi1L4ZtiqrqD80Kn4Z8NTSRyMA2Fd33n5dQ8lWUE00s/" crossorigin="anonymous">
    ...
    function showUser(str) {
      if (str=="") {
        document.getElementById("result").innerHTML="<b>Search</b> Customer using firstname, middlename or lastname <br><i class='material-icons faa-tada animated'>search</i> ";
        return;
      } 
      ...
      xmlhttp.open("GET","operations/getuser.php?t=Customer&q="+str,true);
      xmlhttp.send();
    }
    </script>
</head>
                            ...
                            <a class="nav-link" data-toggle="collapse" href="#collapseUser1" aria-expanded="false" aria-controls="collapseUser1">
                              ...
                              <div class="collapse" id="collapseUser1">
                                    <ul class="nav">
                                        ...
                                        <li class="nav-item active"><a class="nav-link" href="View_User_Customer.php"><i class="fas fa-eye"></i> View Customer</a></li>
                                    </ul>
                              </div>
                        </li>
                        <li class="nav-item">              
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray" href="User_Manager.php">User Management: Customer <i class="fas fa-filter"></i> View</a>/
                  <a class="navbar-brand text-gray-dark" href="View_User_Customer.php">View Customer</a>
              </span>
          </div>
                              ...
                              <div class="col-md-12">
                                <div class="card">
                                  ...
                                  $sql_Fetch_table="SELECT `User_Id`,`First_Name`,`Middle_Name`,`Last_Name`, `Gender`,`DOB`,`Address`, "
                                          ...
                                          . "(SELECT tbl_login.Type FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id) as Type FROM tbl_user where (SELECT tbl_login.Type FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id)='Customer' limit $page,5";
                                 ...
                                 <?php while ($row=$result->fetch_assoc())
                                             ...
                                             <tr>
                                              ...
                                              <div class="modal fade bd-example-modal-lg-<?php echo $row['User_Id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                 ...
                                                 <td class="td-actions text-center" style="display: table-cell">
                                                     <a href="Update_User_Customer.php?fetch=<?php echo $row['User_Id'];?>" rel="tooltip"  data-toggle='tooltip' data-placement='left' title='Update' class="btn btn-success btn-round text-white"  target='_blank'>
                                  ...
                                  <?php $sql_Fetch_table="SELECT `User_Id`,`First_Name`,`Middle_Name`,`Last_Name`, `Gender`,`DOB`,`Address`, (SELECT tbl_country.Name FROM tbl_country WHERE tbl_country.Country_Id=tbl_user.Country_Id) as 'Country', (SELECT tbl_state.Name FROM tbl_state where tbl_state.State_Id=tbl_user.State_Id) as State, (SELECT tbl_city.Name from tbl_city where tbl_city.City_Id=tbl_user.`City_Id`) as City,`PIN_Code`, `Contact_No`, `Email`, (SELECT tbl_login.User_Name FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id) as UserName,`Profile_Picture`, `Social`, `Registration_Date`, `Last_Update_Time`,Login_id,(SELECT tbl_login.Status FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id) as Status,(SELECT tbl_login.Type FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id) as Type FROM tbl_user where (SELECT tbl_login.Type FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id)='Customer'";
                                  $result=  mysqli_query($con, $sql_Fetch_table);
                              ...
                              <div class="col-md-12">
                                  <div class="card">
                                      ...
                                      <div class="card-body text-center">
                                            <div id="result"><b>Search</b> Customer using firstname, middlename or lastname <br><i class="material-icons faa-tada animated">search</i> </div>
                                      </div>
                                  </div>
                              </div>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function(data){
                         if(data=="Deactivated"){
                            ...
                            notify('<i class="fas fa-user-astronaut text-white"></i> &nbsp; <b>Customer Activated</b>','success','top','center')
                         }
                         else{
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                             if(data=="Deleted"){
                                ...
                                notify('<i class="fas fa-user-astronaut text-white"></i> &nbsp; <b>Customer Data Not Deleted</b> <br>'+data,'warning','top','center')
                             }
                         }
                    });
                  }
