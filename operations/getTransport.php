...
while($row = mysqli_fetch_array($result)) 
{
        ...
        echo "<td class='text-center'><a href='Update_Transport.php?fetch=" . $row['Vehicle_Id'] . "' class='faa-parent animated-hover' data-toggle='tooltip' data-placement='top' title='Fetch'><i class='fas fa-bolt faa-tada'></i></a></td>";
        echo "</tr>";
        $COUNT++;
}
echo    "</table>"
