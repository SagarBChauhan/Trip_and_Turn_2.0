...
{echo '<div class="row">';
    ...
    margin-bottom: 10px;">
        ...
        if($vp==1)
        {
            echo '  <a href="Update_Hotel.php?fetch=' . $row['Hotel_Id'] .'" target="_blank" class="btn btn-success btn-just-icon btn-fill btn-round btn-wd">
                        <i class="material-icons">mode_edit</i>
                    </a>
                    <a class="btn btn-danger btn-just-icon btn-fill btn-round text-white trash" id="'.$row['Hotel_Id'].'">
            ...
            echo '<a href="#pablo" class="btn btn-info btn-just-icon btn-fill btn-round" data-toggle="modal" data-target="#previewModel' . $row['Hotel_Id'] .'">
                    ...
                    <a href="?fetch=' . $row['Hotel_Id'] .'" class="btn btn-success btn-just-icon btn-fill btn-round btn-wd">
                        <i class="material-icons">mode_edit</i>
                    </a>
                    <a class="btn btn-danger btn-just-icon btn-fill btn-round text-white trash" id="'.$row['Hotel_Id'].'">
                        <i class="material-icons">delete</i>
