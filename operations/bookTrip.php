...
if(isset($_POST['btn_sub']))
{
    ...
    $query_Insert="INSERT INTO `tbl_trip`( `Customer_Id`, `Vehicle_Id`, `Start_Place`, `End_Place`, `Total_Distance`, `Total_Amount`, `Last_Update_Time`) "
            . "VALUES ($uid,$Vehicle_Id,$placeA,$placeB,$distance,$Total,NOW());";
...
//        {
            ...
            $subject="Your vehicle $Name booked successfully";
            $message="<center>
