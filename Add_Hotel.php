        ...
        <ul class="nav">
          ...
          <li class="nav-item active">
              ...
              <div class="collapse" id="collapseHotel">
                <div class="card card-body">
                    <ul class="nav">
                        <li class="nav-item active"><a class="nav-link" href="Add_Hotel.php"><i class="fas fa-plus"></i> Add Hotel</a></li>
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray-dark" href="Add_Hotel.php">Add Hotel</a>
              </span>
          </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 m-auto justify-content-center">
                            <center>
                            <div class="circle">
                                <img class="profile-pic" title="click to upload picture" src="upload/Image/place/Dubai/326653g8.jpg"/>                     
                            </div>
                      ...
                      <div class="row">
                        <div class="col-md-4">                                        
                            <div class="form-group ">
                                ...
                                <select name="country" class="custom-select" id="country-list" onChange="getState(this.value);" required>
                        ...
                        <div class="col-md-4">                     
                          <div class="form-group">
                              ...
                              <select name="state" class="custom-select" id="state-list"  onChange="getCity(this.value);" class="form-control" required>
                        ...
                        <button type='submit' class="btn  pull-right <?php if(isset($sql_flag)){if($sql_flag==0){echo"btn-success";}elseif ($sql_flag==1) {echo"btn-danger";}  else {echo"btn-primary";}}else {echo"btn-primary";}?> " type="submit" name="btn_Hotel">Add Hotel <i class="fas fa-plus"></i></button>
