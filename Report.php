        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray-dark" href="Report.php">Report</a>
              </span>
          </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                   <div class="col-md-2">
                                     <div class="circle">
                                         <img class="profile-pic" title="click to upload picture" src="upload/Image/dp/default-avatar.png"/>                     
                                     </div>
                                ...
                                <div class="row">
                                   <div class="col-md-2">
                                       <button type="button" class="btn btn-warning btn-round view-change" >Change view</button>
                                   </div>
                                </div>
                            </div>                
                        </div>
