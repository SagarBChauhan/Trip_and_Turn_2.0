...
<head>
  ...
  <script src="js/jquery-3.2.1.min.js" type="text/javascript"></script>
    ...
    function showUser(str) {
      ...
      xmlhttp.open("GET","operations/getPlace.php?vp=1&<?php if (isset($_GET['t'])){ echo 't=1'; } ?>&q="+str,true);
      xmlhttp.send();
    }
    </script>
</head>
              ...
              <div class="collapse" id="collapsePlace">
                <div class="card card-body">
                    <ul class="nav">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="View_Place.php"><i class="fas fa-eye"></i> View Place</a></li>
                    </ul>
                </div>
              </div>
          </li>
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray-dark" href="View_Place.php">View Place</a>
              </span>
          </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="card">
                                  ...
                                  $sql_Fetch_table="SELECT `Place_Id`, `Name`, `Type`, Pictures,`Description`, (SELECT tbl_city.Name FROM tbl_city WHERE tbl_city.City_Id=tbl_place.City_Id) AS City FROM `tbl_place`  limit $page,5;";
                                 ...
                                 <?php while ($row=$result->fetch_assoc())
                                  ...
                                  ?>       
                                             <tr>
                                                <td class="text-center"><?php echo $row['Place_Id'];?></td>
                                               <td><a href='Trip_and_Turn_2.0/<?php echo $row['Pictures']; ?>' target='_blank'/><img class='zoom' src='Trip_and_Turn_2.0/<?php echo $row['Pictures']; ?>' width='30px' style="height: 30px; object-fit: cover;"/></a></td>
                                                <td><?php echo $row['Name'];?></td>
                                                <td><?php echo $row['Type']; ?></td>
                                                <td class="hid"><?php echo $row['Description']; ?></td>
                                                <td><?php echo $row['City']; ?></td>
                                                 <td class="td-actions text-center" style="display: table-cell">
                                                     <button type="button"  data-toggle="modal"  data-target="#previewModel<?php echo $row['Place_Id']; ?>" class="btn btn-info btn-round">
                                                ...
                                                ?>
                                                 <td class="td-actions text-center" style="display: table-cell">
                                                     <a href="Update_Place.php?fetch=<?php echo $row['Place_Id'];?>" rel="tooltip"  data-toggle='tooltip' data-placement='left' title='Update' class="btn btn-success btn-round text-white"  target='_blank'>
                                                         <i class="material-icons">edit</i>
                                                     </a>
                                                 </td>
                                                 <td class="td-actions text-center" style="display: table-cell">
                                                     <button rel="tooltip" data-toggle="tooltip" title="delete" name="btn_del_place" id="<?php echo $row['Place_Id'];?>" class="btn btn-danger btn-round trash">
                                ...
                                <?php $sql_Fetch_table="SELECT `Place_Id`, `Name`, `Type`, `Description`, (SELECT tbl_city.Name FROM tbl_city WHERE tbl_city.City_Id=tbl_place.City_Id) AS City FROM `tbl_place`;";
                                $result=  mysqli_query($con, $sql_Fetch_table);
