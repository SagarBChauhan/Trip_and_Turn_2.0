                            ...
                            <a class="nav-link" data-toggle="collapse" href="#collapseUser2" aria-expanded="false" aria-controls="collapseUser2">
                              ...
                              <div class="collapse" id="collapseUser2">
                                    <ul class="nav">
                                        ...
                                        <li class="nav-item active"><a class="nav-link" href="View_User_Employee.php"><i class="fas fa-eye"></i> View Employee</a></li>
                                    </ul>
                              </div>
                        </li>
                        <li class="nav-item">              
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray" href="User_Manager.php">User Management: Employee <i class="fas fa-filter"></i> View</a>/
                  <a class="navbar-brand text-gray-dark" href="View_User_Employee.php">View Employee</a>
              </span>
          </div>
                              ...
                              <div class="col-md-12">
                                <div class="card">
                                  ...
                                  $sql_Fetch_table="SELECT `User_Id`,`First_Name`,`Middle_Name`,`Last_Name`, `Gender`,`DOB`,`Address`, "
                                          ...
                                          . "where (SELECT tbl_login.Type FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id)='Employee' limit $page,5";
                                 ...
                                 <?php while ($row=$result->fetch_assoc())
                                             ...
                                             <tr>
                                              ...
                                              <div class="modal fade bd-example-modal-lg-<?php echo $row['User_Id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                 ...
                                                 <td class="td-actions text-center" style="display: table-cell">
                                                     <a href="Update_User_Employee.php?fetch=<?php echo $row['User_Id'];?>" rel="tooltip"  data-toggle='tooltip' data-placement='left' title='Update' class="btn btn-success btn-round text-white"  target='_blank'>
                                  ...
                                  <?php $sql_Fetch_table="SELECT `User_Id`,`First_Name`,`Middle_Name`,`Last_Name`, `Gender`,`DOB`,`Address`, (SELECT tbl_country.Name FROM tbl_country WHERE tbl_country.Country_Id=tbl_user.Country_Id) as 'Country', (SELECT tbl_state.Name FROM tbl_state where tbl_state.State_Id=tbl_user.State_Id) as State, (SELECT tbl_city.Name from tbl_city where tbl_city.City_Id=tbl_user.`City_Id`) as City,`PIN_Code`, `Contact_No`, `Email`, (SELECT tbl_login.User_Name FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id) as UserName,`Profile_Picture`, `Social`, `Registration_Date`, `Last_Update_Time`,Login_id,(SELECT tbl_login.Status FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id) as Status,(SELECT tbl_login.Type FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id) as Type FROM tbl_user"
                                          . " where (SELECT tbl_login.Type FROM tbl_login WHERE tbl_login.Login_id=tbl_user.Login_id)='Employee'";
                                  $result=  mysqli_query($con, $sql_Fetch_table);
            ...
            $(document).on('click','#Status',function(){
                ...
                $.ajax({
                    ...
                    success: function(data){
                         if(data=="Deactivated"){
                            notify('<i class="fas fa-user-tie text-white"></i> &nbsp; <b>Employee Deactivated</b>','warning','top','center')
                         }
                         else if(data=="Activated"){
                            notify('<i class="fas fa-user-tie text-white"></i> &nbsp; <b>Employee Activated</b>','success','top','center')
                         }
                         else{
                  ...
                  if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                             if(data=="Deleted"){
                                $ele.fadeOut().remove();
                                notify('<i class="fas fa-user-tie text-white"></i> &nbsp; <b>Employee Data Deleted</b>','success','top','center')
                             }else{
                                notify('<i class="fas fa-user-tie text-white"></i> &nbsp; <b>Employee Data Not Deleted</b> <br>'+data,'warning','top','center')
                             }
                         }
                    });
                  }
