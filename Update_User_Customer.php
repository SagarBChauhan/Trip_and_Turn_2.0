                            ...
                            <a class="nav-link" data-toggle="collapse" href="#collapseUser1" aria-expanded="false" aria-controls="collapseUser1">
                              ...
                              <div class="collapse" id="collapseUser1">
                                    <ul class="nav">
                                        ...
                                        <li class="nav-item active"><a class="nav-link" href="Update_User_Customer.php"><i class="fas fa-pencil-alt"></i> Update Customer</a></li>
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray" href="User_Manager.php">User Management: Customer <i class="fas fa-filter"></i> Update</a>/
                  <a class="navbar-brand text-gray-dark" href="Update_User_Customer.php">Update Customer</a>
              </span>
          </div>
