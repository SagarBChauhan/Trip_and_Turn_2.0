...
<head>
  ...
  <script src="js/jquery-3.2.1.min.js" type="text/javascript"></script>
    ...
    function showUser(str) {
      ...
      xmlhttp.open("GET","operations/getPackage.php?vp=1&<?php if (isset($_GET['t'])){ echo 't=1'; } ?>&q="+str,true);
      xmlhttp.send();
    }
    </script>
</head>
              ...
              <div class="collapse" id="collapsePackage">
                <div class="card card-body">
                    <ul class="nav">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="View_Package.php"><i class="fas fa-eye"></i> View Package</a></li>
                    </ul>
                </div>
              </div>
          </li>
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray-dark" href="View_Package.php">View Package</a>
              </span>
          </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="card">
                                  ...
                                  $sql_Fetch_table="SELECT `Package_Id`, `Name`, `Type`, `Cost`, (SELECT tbl_place.Name FROM tbl_place WHERE tbl_place.Place_Id=tbl_package.Place_Id) as place, `Description`, `Picture`, `Number_Person`, `Days`, `Nights`, `Last_Update_Time` FROM `tbl_package` limit $page,5;";
                                      ...
                                      <table class="table table-hover">
                                         <thead>
                                             <tr>
                                                ...
                                                <th>Cost</th>
                                                <th>place</th>
                                                <th class="hid">Description</th>
                                                <th>Person</th>
                                                <th>Days</th>
                                                <th>Nights</th>
                                                <th class="hid">Last_Update_Time</th>
                                 ...
                                 <?php while ($row=$result->fetch_assoc())
                                  ...
                                  ?>       
                                             <tr>
                                               ...
                                               <td><a href='Trip_and_Turn_2.0/<?php echo $row['Picture']; ?>' target='_blank'/><img class='zoom' src='Trip_and_Turn_2.0/<?php echo $row['Picture']; ?>' width='30px' style="height: 30px; object-fit: cover;"/></a></td>
                                                <td><?php echo $row['Name'];?></td>
                                                <td><?php echo $row['Type']; ?></td>
                                                <td><?php echo $row['Cost']; ?>  &#x20B9;</td>
                                                <td><?php echo $row['place']; ?></td>
                                                <td class="hid"><?php echo $row['Description']; ?></td>
                                                ...
                                                <td class="hid"><?php echo $row['Last_Update_Time']; ?></td>
                                                 <td class="td-actions text-center" style="display: table-cell">
                                                     <button type="button"  data-toggle="modal"  data-target="#previewModel<?php echo $row['Package_Id']; ?>" class="btn btn-info btn-round">
                                                ...
                                                ?>
                                                 <td class="td-actions text-center" style="display: table-cell">
                                                     <a href="Update_Package.php?fetch=<?php echo $row['Package_Id'];?>" rel="tooltip"  data-toggle='tooltip' data-placement='left' title='Update' class="btn btn-success btn-round text-white"  target='_blank'>
                                                         <i class="material-icons">edit</i>
                                                     </a>
                                                 </td>
                                                 <td class="td-actions text-center" style="display: table-cell">
                                                     <button rel="tooltip" data-toggle="tooltip" title="delete" name="btn_del_package" id="<?php echo $row['Package_Id'];?>" class="btn btn-danger btn-round trash">
                                ...
                                <?php $sql_Fetch_table="SELECT `Package_Id`, `Name`, `Type`, `Cost`, (SELECT tbl_place.Name FROM tbl_place WHERE tbl_place.Place_Id=tbl_package.Place_Id) as place, `Description`, `Picture`, `Number_Person`, `Days`, `Nights`, `Last_Update_Time` FROM `tbl_package` ;";
                                $result=  mysqli_query($con, $sql_Fetch_table);
