                        ...
                        <li class="nav-item active">              
                            <a class="nav-link" data-toggle="collapse" href="#collapseUser3" aria-expanded="false" aria-controls="collapseUser3">
                              ...
                              <div class="collapse" id="collapseUser3">
                                    <ul class="nav">
                                        <li class="nav-item active"><a class="nav-link " href="Add_User_Guide.php"><i class="fas fa-plus"></i> Add Guide</a></li>
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray" href="User_Manager.php">User Management: Guide <i class="fas fa-filter"></i> Add</a>/
                  <a class="navbar-brand text-gray-dark" href="Add_User_Guide.php">Add Guide</a>
              </span>
          </div>
                ...
                <div class="card-body">                    
                    ...
                    <form id="myForm"  method="POST">
                      ...
                      <div class="row">
                        ...
                        <button type='submit' name="btn_Add_Guide" id="btn_Add_Guide" class="btn btn-primary  pull-right" disabled>Add  <i class="fas fa-plus"></i></button>
        ...
        <script>
            function checkUsername(str) {
              ...
              if (str == "") {
                ...
                $("#btn_Add_Guide").attr('disabled',true);
                $("#feedback").remove();
              ...
              xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                  if(this.responseText=='ok')
                  {
                    ...
                    $("#btn_Add_Guide").attr('disabled',false);
            ...
            $(document).ready(function (){
                ...
                function subform(){
                    ...
                    $.ajax({
                        ...
                        beforeSend: function () {
                            $("#info").fadeOut();
                            $("#btn_Add_Guide").html("Please Wait <i class='fas fa-spinner fa-spin'></i>");
                        },
                        success: function (resp) {
                            if(resp=='Added'){
                                $("#btn_Add_Guide").html("Added");
                                notify('Guide Added <i class="fas fa-check faa-burst animated faa-fast></i>','success','top','center');
                            }
                            else
                            {
                                $("#info").fadeIn(1000,function (){
//                                    $("#info").html("<div class='alert alert-danger'>"+resp+"</div>");
                                    $("#btn_Add_Guide").html('Add');
                                }) 
