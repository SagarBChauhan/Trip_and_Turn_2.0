              ...
              <div class="collapse" id="collapseTransportation">
                <div class="card card-body">
                    <ul class="nav">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="Update_Transport.php"><i class="fas fa-pencil-alt"></i> Update Transport</a></li>
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray-dark" href="Update_Transport.php">Update Transport</a>
              </span>
          </div>
                        ...
                        <div class="card-header card-header-text card-header-primary">
                          <div class="card-text">
                              <div class="input-group no-border Thumbnail">
                                    <input type="text" class="form-control text-white" onkeyup="showUser(this.value)"  placeholder="Search transport...">
                                    <button type="submit" class="btn btn-white btn-round btn-just-icon">
                          ...
                          <div class="col-md-4">                                        
                            <div class="form-group ">
                                ...
                                <select name="Transport_type" class="custom-select"  required>
                                    <option value="<?php echo $Trans_Type_Id;?>"  selected><?php echo $Trans_Type_Id;?></option>
                      ...
                      <div class="row">   
                        <div class="col-md-3">                        
                          <div class="form-group">                          
                                ...
                                <input type="text" name="Company" value="<?php echo $Company;?>" class="form-control" required>
                                <input type="hidden" name="Vehicle_Id" value="<?php echo $Vehicle_Id;?>" required>
                          </div>
                        </div>
                        <div class="col-md-3">                        
                          <div class="form-group">                          
                        ...
                        <div class="col-md-3">                        
                          <div class="form-group">                          
                                ...
                                <input type="number" name="Cost" min="0" value="<?php echo $Cost_Per_KM;?>"  class="form-control" required>
                          </div>
                        </div>
                      </div>
                        <button  class="btn  pull-right btn-primary " type="submit" id="btn_Sub" name="btn_Sub">Update Transport</button>
    ...
    $(document).ready(function (){
        ...
        function subform(){
            ...
            $.ajax({
                ...
                url: "operations/updateTransport.php",
                data:  data,
                beforeSend : function()
                {
                ...
                success: function (resp) {
                    if(resp=="ok"){
                        $("#btn_Sub").fadeIn(1000,function (){
                            $("#btn_Sub").html("Update <i class='fas fa-check faa-burst animated'></i>");
                        })
                        notify('Done','success','top','center');  
                    }                        
                    else if(resp=="no"){
                        $("#btn_Sub").fadeIn(1000,function (){
                            $("#btn_Sub").html("Update");
