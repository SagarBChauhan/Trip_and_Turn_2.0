                            ...
                            <a class="nav-link" data-toggle="collapse" href="#collapseUser3" aria-expanded="false" aria-controls="collapseUser3">
                              ...
                              <div class="collapse" id="collapseUser3">
                                    <ul class="nav">
                                        ...
                                        <li class="nav-item active"><a class="nav-link" href="Update_User_Guide.php"><i class="fas fa-pencil-alt"></i> Update Guide</a></li>
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
              <span>
                  ...
                  <a class="navbar-brand text-gray" href="User_Manager.php">User Management: Guide <i class="fas fa-filter"></i> Update</a>/
                  <a class="navbar-brand text-gray-dark" href="Update_User_Guide.php">Update Guide</a>
              </span>
          </div>
